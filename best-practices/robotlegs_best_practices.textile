...
mapValue(MyClass, myClassInstance);</pre>
...
<pre>//someplace in your application where mapping/configuration occurs
mapSingletonOg(IMyClass, MyClass); //MyClass implements IMyClass</pre>
...
<pre>//someplace in your application where mapping/configuration occurs
mapView(MyAwesomeWidget, MyAwesomeWidgetMediator); </pre>
...
<pre>//someplace in your application where mapping/configuration occurs
mapEvent(MyCoolCommand, MyAppDataEvent.DATA_WAS_RECEIVED, MyAppDataEvent); </pre>
